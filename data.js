...
const PORTFOLIO_DATA = {
  ...
  ctaButton: { label: "Let's Connect →", href: "https://www.linkedin.com/in/jptondapu" },

  /* ── HERO ───────────────────────────────────────────────── */
  hero: {
    greeting:    "Hey there,",
    headline:    "I'm Jay Prakash Tondapu",
    subheadline: "Senior Product Manager",
    description: "14+ years shaping customer identity, loyalty & personalization at scale — turning complex data into products people love.",
    profileImage: "assets/JP-LinkedIn-Photo.jpeg",   // ← replace with your photo filename
    stats: [
      { value: "14+", label: "Years of\nImpact" },
  ...
  about: {
    ...
    body: [
      "With 14+ years of product management experience across grocery, retail, and e-commerce, I specialize in customer identity, loyalty, personalization, and cross-functional platform initiatives.",
  ...
  projects: [
    ...
    {
      title:       "Organic Produce — Organic Farmer Web App",
    ...
    {
      title:       "Menu Helper — AI-Powered Menu Scanning Prototypes",
      tags:        ["V0", "AI"],
  ...
  /* ── TESTIMONIAL ────────────────────────────────────────── */
  testimonial: {
    quote: "JP has a rare ability to bridge complex technical architecture with clear customer value. His work on our identity platform directly moved the needle on loyalty sign-ups and retention — a true cross-functional leader.",
  ...
  social: [
    { label: "LinkedIn", href: "https://www.linkedin.com/in/jptondapu", icon: "linkedin" },
    { label: "GitHub",   href: "https://github.com/jtondapu",          icon: "github"   },
  ],

  /* ── FOOTER ─────────────────────────────────────────────── */
  footer: {
    copyright: "© 2025 Jaya Prakash Tondapu. All rights reserved.",
  },
